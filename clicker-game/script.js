...
// Use corsproxy.io to access HTTP Dreamlo from HTTPS Vercel
const PROXY_URL = 'https://corsproxy.io/?url=';
const DREAMLO_BASE = 'http://dreamlo.com/lb/' + DREAMLO_CODE;
...
function submitOnlineScore(level) {
    ...
    // Encoded for Proxy
    const targetUrl = `${DREAMLO_BASE}/add/${encodeURIComponent(name)}/${level}`;
...
function showRanking() {
    ...
    const targetUrl = `${DREAMLO_BASE}/json`;
    const url = PROXY_URL + encodeURIComponent(targetUrl);
